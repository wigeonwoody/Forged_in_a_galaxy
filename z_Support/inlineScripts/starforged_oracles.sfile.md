...
if (capResult.contains("ROLL TWICE")) {
    ...
    result1 = expand("tbl roll z_Oracles/Core/Core_Action.md");
    result2 = expand("tbl roll z_Oracles/Core/Core_Theme.md");
    trueResult = "Action/Theme - " + result1 + " " + result2;
} else if (capResult.contains("DESCRIPTOR") && iResult[0].contains("FOCUS")) {
    result1 = expand("tbl roll z_Oracles/Core/Core_Descriptor.md");
    result2 = expand("tbl roll z_Oracles/Core/Core_Focus.md");
...
if (result1[0].includes("Descriptor") && result1[0].includes("Focus")) {
    extra1 = expand("tbl roll z_Oracles/Core/Core_Descriptor.md");
    extra2 = expand("tbl roll z_Oracles/Core/Core_Focus.md");
    addDetails = "Descriptor/Focus: " + extra1 + " " + extra2 + "\n\n";
} else if (result1[0].includes("Action") && result1[0].includes("Theme")) {
    extra1 = expand("tbl roll z_Oracles/Core/Core_Action.md");
    extra2 = expand("tbl roll z_Oracles/Core/Core_Theme.md");
...
__
```js
let action = expand("tbl roll z_Oracles/Core/Core_Action.md");
let theme = expand("tbl roll z_Oracles/Core/Core_Theme.md");
...
__
```js
let descriptor = expand("tbl roll z_Oracles/Core/Core_Descriptor.md");
let focus = expand("tbl roll z_Oracles/Core/Core_Focus.md");
...
__
```js
let given = expand("tbl roll z_Oracles/Characters/Characters_Given_Name.md");
let family = expand("tbl roll z_Oracles/Characters/Characters_Family_Name.md");
let callsign = expand("tbl roll z_Oracles/Characters/Characters_Callsign.md");
let name = given + " \"" + callsign + "\" " + family;
let fl = "**First Look:** " + expand("getOracle z_Oracles/Characters/Characters_First_Look.md");
let goal = "**Goal:** " + expand("getOracle z_Oracles/Characters/Characters_Goal.md");
let iniDis = "**Initial Disposition:** " + expand("getOracle z_Oracles/Characters/Characters_Initial_Disposition.md");
let revAsp = "**Revealed Aspect:** " + expand("getOracle z_Oracles/Characters/Characters_Revealed_Aspect.md");
let role = "**Role:** " + expand("getOracle z_Oracles/Characters/Characters_Role.md");
...
let name = expand("tbl roll z_Oracles/Settlements/Settlements_Name.md");
let location = "**Location:** " + expand("tbl roll z_Oracles/Settlements/Settlements_Location.md");
let fl = "**First Look:** " + expand("tbl roll z_Oracles/Settlements/Settlements_First_Look.md");
let iniCon = "**Initial Contact:** " + expand("tbl roll z_Oracles/Settlements/Settlements_Initial_Contact.md");
let authority = "**Authority:** " + expand("tbl roll z_Oracles/Settlements/Settlements_Authority.md");
let project = "**Project:** " + expand("tbl roll z_Oracles/Settlements/Settlements_Projects.md");
let trouble = "**Trouble:** " + expand("tbl roll z_Oracles/Settlements/Settlements_Trouble.md");
let pop = "**Population:** " + expand("tbl roll z_Oracles/Settlements/Settlements_Population_" + area + ".md");
...
__
```js
let type = "**Type:** " + expand("tbl roll z_Oracles/Factions/Factions_Type.md");
var specificType = "";
if (type.includes("Dominion")) {
    specificType = "**Dominion:** " + expand("tbl roll z_Oracles/Factions/Factions_Dominion.md");
} else if (type.includes("Guild")) {
    specificType = "**Guild:** " + expand("getOracle z_Oracles/Factions/Factions_Guild.md");
} else if (type.includes("Fringe")) {
    specificType = "**Fringe Group:** " + expand("getOracle z_Oracles/Factions/Factions_Fringe_Group.md");
} else if (type.includes("Corporation")) {
    specificType = "**Corporation Field:** " + expand("getOracle z_Oracles/Factions/Factions_Corporation_Field.md");
} else if (type.includes("Military")) {
    specificType = "**Military Specialty:** " + expand("getOracle z_Oracles/Factions/Factions_Military_Specialty.md");
} else if (type.includes("Religious")) {
    specificType = "**Religious Group Role:** " + expand("getOracle z_Oracles/Factions/Factions_Religious_Role.md");
} else if (type.includes("Research")) {
    specificType = "**Research Field of Study:** " + expand("getOracle z_Oracles/Factions/Factions_Research_Field_of_Study.md");
} else if (type.includes("Data")) {
    specificType = "**Data Harvesters Role:** " + expand("getOracle z_Oracles/Factions/Factions_Data_Harvesters_Role.md");
} else if (type.includes("AI Hive")) {
    specificType = "**AI Hive Prime Directive:** " + expand("getOracle z_Oracles/Factions/Factions_AI_Hive_Prime_Directive.md");
} else {
    specificType = "**Dominion:** " + expand("tbl roll z_Oracles/Factions/Factions_Dominion.md");
}
let influence = "**Influence:** " + expand("tbl roll z_Oracles/Factions/Factions_Influence.md");
let leadership = "**Leadership:** " + expand("tbl roll z_Oracles/Factions/Factions_Leadership.md");
let project = "**Project:** " + expand("getOracle z_Oracles/Factions/Factions_Projects.md");
let quirk = "**Quirk:** " + expand("getOracle z_Oracles/Factions/Factions_Quirks.md");
let rumor = "**Rumor:** " + expand("getOracle z_Oracles/Factions/Factions_Rumors.md");
let affil = expand("tbl roll z_Oracles/Factions/Factions_Name_Affiliation.md");
let legacy = expand("tbl roll z_Oracles/Factions/Factions_Name_Legacy.md");
let identity = expand("tbl roll z_Oracles/Factions/Factions_Name_Identity.md");
let template = expand("tbl roll z_Oracles/Factions/Factions_Name_Template.md");
...
let name = expand("tbl roll z_Oracles/Starships/Starships_Name.md");
let fl = "**First Look:** " + expand("getOracle z_Oracles/Starships/Starships_First_Look.md");
let iniCon = "**Initial Contact:** " + expand("tbl roll z_Oracles/Starships/Starships_Initial_Contact.md");
let type = "**Class:** " + expand("tbl roll z_Oracles/Starships/Starships_Type.md");
let mission = "**Mission:** " + expand("getOracle z_Oracles/Starships/Starships_Mission_" + area + ".md");
...
var environment = "Air";
if (input == null) {
    environment = expand("tbl roll z_Oracles/Creatures/Creatures_Environment.md");
} else {
    environment = input.charAt(0).toUpperCase() + input.slice(1).toLowerCase();
}
let form = "Form: " + expand("getOracle z_Oracles/Creatures/Creatures_Basic_Form_" + environment + ".md");
let trueEnv = "**Environment:** " + environment;
let scale = expand("tbl roll z_Oracles/Creatures/Creatures_Scale.md");
var trueScale = "";
if (scale.contains("scale")) {
    trueScale = "**Scale:** " + expand("tbl roll z_Oracles/Creatures/Creatures_Ultra_Scale.md");
} else {
    trueScale = "**Scale:** " + scale[0];
}
let fl = "**First Look:** " + expand("tbl roll z_Oracles/Creatures/Creatures_First_Look.md");
let ra = "**Revealed Aspect:** " + expand("tbl roll z_Oracles/Creatures/Creatures_Revealed_Aspect.md");
let eb = "**Encountered Behavior:** " + expand("getOracle z_Oracles/Creatures/Creatures_Encountered_Behavior.md");
...
__
```js
let type = expand("tbl roll z_Oracles/Derelicts/Derelicts_Location_and_Type.md");
let fl = "**Outer First Look:** " + expand("tbl roll z_Oracles/Derelicts/Derelicts_Outer_First_Look.md");
let con = "**Condition:** " + expand("tbl roll z_Oracles/Derelicts/Derelicts_Condition.md");
var zone = "";
if (type[0].contains("Starship")) {
    zone = "**Starting Zone:** " + expand("tbl roll z_Oracles/Derelicts/Derelicts_Zones_Starship.md");
} else {
    zone = "**Starting Zone:** " + expand("tbl roll z_Oracles/Derelicts/Derelicts_Zones_Settlement.md");
}
...
__
```js
let fl = "**Outer First Look:** " + expand("tbl roll z_Oracles/Vaults/Vaults_Outer_First_Look.md");
let form = "**Form:** " + expand("tbl roll z_Oracles/Vaults/Vaults_Form.md");
let location = "**Location:** " + expand("tbl roll z_Oracles/Vaults/Vaults_Location.md");
let scale = "**Scale:** " + expand("tbl roll z_Oracles/Vaults/Vaults_Scale.md");
if (scale.includes("Ultra")) {
    scale = "**Scale:** " + expand("tbl roll z_Oracles/Vaults/Vaults_Ultra_Scale.md");
}
let material = "**Material:** " + expand("getOracle z_Oracles/Vaults/Vaults_Material.md");
let shape = "**Shape:** " + expand("getOracle z_Oracles/Vaults/Vaults_Shape.md");
...
var trueClass = "";
if (pClass == "Random") {
    let rolledClass = expand("tbl roll z_Oracles/Planets/Planets_Class.md");
...
let atmo = "**Atmosphere:** " + expand("tbl roll z_Oracles/Planets/" + trueClass + "/Planets_" + trueClass + "_Atmosphere.md");
let feat = "**Feature:** " + expand("getOracle z_Oracles/Planets/" + trueClass + "/Planets_" + trueClass + "_Feature.md");
let life = "**Life:** " + expand("tbl roll z_Oracles/Planets/" + trueClass + "/Planets_" + trueClass + "_Life.md");
let obsv = "**Observed from Space:** " + expand("getOracle z_Oracles/Planets/" + trueClass + "/Planets_" + trueClass + "_Observed_from_Space.md");
let sett = "**Settlements:** " + expand("tbl roll z_Oracles/Planets/" + trueClass + "/Planets_" + trueClass + "_Settlements_" + region + ".md");
let name = "**Planet:** " + expand("tbl roll z_Oracles/Planets/" + trueClass + "/Planets_" + trueClass + "_Name.md");
let area = "**Region:** " + region;
let callout = "> [!oracle]- " + name + ", Class: " + trueClass;
let nextStep = "\n>" + area + "\n> " + obsv + "\n> " + atmo + "\n> " + feat + "\n> " + life;
var finalAdd = "";
if (trueClass == "Vital") {
    let diversity = expand("tbl roll z_Oracles/Planets/Vital/Planets_Vital_Diversity.md");
    var numBio = 2;
    ...
    for (let i = 0; i < numbBio; i = i + 1) {
        if (i == 0) {
            biomes = biomes + expand("tbl roll z_Oracles/Planets/Vital/Planets_Vital_Biomes.md");
        } else {
            biomes = biomes + ", " + expand("tbl roll z_Oracles/Planets/Vital/Planets_Vital_Biomes.md");
        }
    }
...
let sighting = "**Sighting:** " + expand("getOracle z_Oracles/Space/Space_Sighting_" + area + ".md") + " (Roll for the sighting separately)";
let stellar = "**Stellar Object:** " + expand("getOracle z_Oracles/Space/Space_Stellar_Object.md");
let region = "**Region:** " + area;
let prefix = expand("tbl roll z_Oracles/Space/Space_Sector_Name_Prefix.md");
let suffix = expand("tbl roll z_Oracles/Space/Space_Sector_Name_Suffix.md");
let name = "**Name:** The " + prefix + " " + suffix;
let trouble = "**Trouble**: " + expand("getOracle z_Oracles/Campaign/Campaign_Sector_Trouble.md");
...
__
```js
let result = expand("getOracle z_Oracles/Moves/Moves_Pay_the_Price.md");
